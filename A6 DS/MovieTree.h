...
public:
    ...
    MovieNodeBST* createNode(char Zletter);
    MovieNodeBST* insertNodeHelper(MovieNodeBST* curNode, char Zletter);
    MovieTree(char Zletter);
    bool searchKeyHelper(MovieNodeBST* root, char Zletter);
    bool searchKey(char Zletter);
    MovieNodeBST* searchKeyHelperLetter(MovieNodeBST* root, char Zletter);
    MovieNodeBST* searchKeyLetter(char Zletter);
